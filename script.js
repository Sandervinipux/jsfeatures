...
//пример разрастания дерева call-back функции

//пример разрастания дерева call-back-ов (call_back hell)
console.log("Запрос данных...");

setTimeout(()=>{
    console.log("Подготовка даныхх... ");
...
//Рабочий вариант
console.log("Запрос данных...");
сonst req = new Promise((resolve, reject)=> {
    setTimeout(()=>{
        console.log("Подготовка данных...");
